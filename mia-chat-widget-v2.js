...
(function() {
    ...
    console.log("Loading custom Mia Chat Widget v1.4 (Build: " + cacheBuster + ")");
    ...
    function updateImageWithTimestamp(imgElement, originalSrc) {
        ...
        if (originalSrc.includes('?')) {
            imgElement.src = `${originalSrc}&_t=${cacheBuster}`;
        } else {
            imgElement.src = `${originalSrc}?_t=${cacheBuster}`;
        }
    }
    ...
    console.log("Mia Chat Widget initialized successfully v1.4");
})();